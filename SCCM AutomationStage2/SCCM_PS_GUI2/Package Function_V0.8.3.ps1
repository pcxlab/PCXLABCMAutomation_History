function Create-Package { 
    ...
    # ---------------------------------------
    New-CMProgram -PackageName $Packagename -StandardProgramName $ProgramName1 -CommandLine "msiexec /i PuTTY-0.83-Installer.msi /qn /norestart" -RunMode RunWithAdministrativeRights -ProgramRunType WhetherOrNotUserIsLoggedOn
    New-CMProgram -PackageName $Packagename -StandardProgramName $ProgramName2 -CommandLine "msiexec /i PuTTY-0.83-Installer.msi /qn /norestart" -RunMode RunWithAdministrativeRights -ProgramRunType WhetherOrNotUserIsLoggedOn
    New-CMProgram -PackageName $Packagename -StandardProgramName $ProgramName3 -CommandLine "msiexec /x PuTTY-0.83-Installer.msi /qn" -RunMode RunWithAdministrativeRights -ProgramRunType WhetherOrNotUserIsLoggedOn
