...
Clear-Host
Set-Location C:\Projects\PCXLABCMAutomation_ADDOSREQ\
Remove-Module PCXLab.SCCM -Force
Import-Module .\src\Modules\PCXLab.SCCM
Connect-PCXCMSite
...
Cleanup-PCXCMPackageDeployment `
    -packagename     "PKG Tim Kosse FileZila 7.02.1.0"

Cleanup-PCXCMPackageDeployment `
    -packagename     "PKG Igor Pavlov 7zip 26.0.0"

#Cleanup-PCXCMPackageDeployment -PackageName "Tim Kosse FileZila 2.12.1.0" 
Cleanup-PCXCMPackageDeployment -PackageName "PKG Tim Kosse FileZila 2.12.1.0" 
Cleanup-PCXCMPackageDeployment -PackageName "PKG Tim Kosse FileZila 3.69.6.0"  
Cleanup-PCXCMPackageDeployment -PackageName "PKG Tim Kosse FileZila 5.12.3.0"  
Cleanup-PCXCMPackageDeployment -PackageName "PKG Tim Kosse FileZila 7.02.1.0"  
Cleanup-PCXCMPackageDeployment -PackageName "PKG Tim Kosse FileZila 89.02.1.0"  

Cleanup-PCXCMApplicationDeployment -ApplicationName "APP Tim Kosse FileZila 2.12.1.0" 
...
Cleanup-PCXCMApplicationDeployment -ApplicationName "APP Tim Kosse FileZila 7.02.1.0"  
Cleanup-PCXCMApplicationDeployment -ApplicationName "APP Tim Kosse FileZila 89.02.1.0"  
<#
Mode                 LastWriteTime         Length Name
----                 ------------ - ------ ----
d-----          6/8/2026   1:28 AM                Tim Kosse FileZila 2.12.1.0
d-----         3/21/2026   3:10 PM                Tim Kosse FileZila 3.69.6.0
d-----          6/6/2026   3:54 AM                Tim Kosse FileZila 5.12.3.0
d-----          6/8/2026  12:52 AM                Tim Kosse FileZila 7.02.1.0
d-----          6/8/2026   1:34 AM                Tim Kosse FileZila 89.02.1.0

Remove-PCXCMApplication -Name "Tim Kosse FileZila 3.69.5.0" -Force    



Get-ChildItem -Path "E:\Package_source\Applications\Tim Kosse\FileZila"
#>

    


Get-CMPackage | Select-Object Name 
...
Cleanup-PCXCMPackageDeployment -Packagename "PKG Igor Pavlov 7zip 26.0.2"
Cleanup-PCXCMApplicationDeployment -ApplicationName "APP Igor Pavlov 7zip 26.0.2"
Cleanup-PCXCMApplicationDeployment -ApplicationName "APP Igor Pavlov 7zip 26.0.1"
...
Clear-Host
Remove-Module PCXLab.SCCM -Force
cd "F:\Development\PCXCMAutomation_V11_GUI"
Import-Module .\src\Modules\PCXLab.SCCM

Connect-PCXCMSite

$APP = "Igor Pavlov 7zip 26.0.2"
$APP = "APP Tim Kosse FileZila 2.12.1.0"
$APP = "APP Tim Kosse FileZila 7.02.1.0"
...
Create-PCXCMPackage -Path "\\172.16.100.56\Package_Source\Applications\Google\Chrome\Google Chrome 500.0.7499.41"
