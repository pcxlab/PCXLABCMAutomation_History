function Create-PCXCMPackage {
    ...
    process {
        ...
        try {
            ...
            $programs = Get-PCXCMPackageProgramNames -PackageName $PackageName
            $Collections = Get-PCXCMDeploymentCollectionNames -ObjectName $PackageName
            ...
            New-PCXCMDeploymentCollections -Collections $Collections -LimitingCollectionName $LimitingCollectionName
