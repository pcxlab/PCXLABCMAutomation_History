function Add-PCXCMApplicationOSRequirement {
    ...
    process {
        try {
            ...
            Write-PCXLog "Failed OS requirement operation for application '$ApplicationName'. $_"
            throw
        }
        finally {
            Write-PCXLog "Application OS requirement operation completed: $ApplicationName"
        }
    }
    end {
