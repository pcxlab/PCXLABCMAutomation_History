        ...
        try {
            ...
            switch ($extension) {
                ...
                ".exe" {
                    ...
                    Write-PCXLog "Add-CMScriptDeploymentType completed successfully"
                    $ResultDeploymentType = Get-CMDeploymentType -ApplicationName $Name -ErrorAction SilentlyContinue
                    Write-PCXLog "Deployment Types Found : $(@($ResultDeploymentType).Count)"
                    foreach ($DeploymentType in @($ResultDeploymentType)) {
                        Write-PCXLog "Deployment Type : $($DeploymentType.LocalizedDisplayName)"
                    }
