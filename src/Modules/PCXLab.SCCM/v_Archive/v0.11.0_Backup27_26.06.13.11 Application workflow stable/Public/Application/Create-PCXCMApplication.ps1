function Create-PCXCMApplication {
    ...
    process {
        ...
        try {
            ...
            #New-PCXCMApplication -ApplicationName $ApplicationName -Description $ApplicationName -Publisher $Meta.Company -SoftwareVersion $Meta.Version -ReleaseDate (Get-Date) -Iconlocationfile $(if ($IconFile) { $IconFile.FullName })
