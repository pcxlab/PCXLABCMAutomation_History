function Add-PCXCMApplicationDiskSpaceRequirementToDeploymentType {
    ...
    process {
        try {
            ...
            $Application = Get-PCXCMCachedApplication | Where-Object { $_.LocalizedDisplayName -eq $ApplicationName } | Select-Object -First 1
