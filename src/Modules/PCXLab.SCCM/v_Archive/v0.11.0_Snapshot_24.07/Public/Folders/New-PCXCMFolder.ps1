function New-PCXCMFolder {
    ...
    process {
        ...
        try {
            ...
            Write-PCXLog "Folder traversal took $([math]::Round($LoopStopwatch.Elapsed.TotalSeconds,2)) sec"
            ...
            foreach ($folder in $segments) {
                ...
                Write-PCXLog "Folder segment '$folder' took $([math]::Round($SegmentStopwatch.Elapsed.TotalSeconds,2)) sec"
            ...
            Write-PCXLog "Folder ensured in $([math]::Round($Stopwatch.Elapsed.TotalSeconds,2)) sec"
            # -------------------------------
