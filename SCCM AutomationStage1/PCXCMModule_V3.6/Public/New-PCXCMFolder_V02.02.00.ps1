...
###############################
# Remove logic implimentation

function Remove-PCXCMFolder {
    param($Path)

    Get-ChildItem $Path | ForEach-Object {
        Remove-AllItems $_.PSPath
        Remove-Item $_.PSPath
    }
}

Remove-PCXCMFolder "PS1:\DeviceCollection\RootFolder"
#Remove-Item "PS1:\DeviceCollection\RootFolder"
...
Remove-Item -Path PS1:\DeviceCollection\RootFolder -Recurse
